...
const TABLE: Array[Array] = [
	...
	[ 20.0,  25.0,  30.0,  20.0,  5.0,  0.0,  0.0,  0.0, 0.0],  # B
	[ 12.0,  18.0,  25.0,  25.0, 15.0,  5.0,  0.0,  0.0, 0.0],  # A
	[  8.0,  12.0,  18.0,  22.0, 20.0, 13.0,  6.0,  1.0, 0.0],  # S
	[  5.0,   8.0,  12.0,  17.0, 20.0, 18.0, 13.0,  6.0, 1.0],  # SS
	[  3.0,   5.0,   8.0,  12.0, 17.0, 20.0, 18.0, 12.0, 5.0],  # SSS
]
