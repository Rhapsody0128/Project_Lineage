...
## 聊天已接上 DialogueBox、休息已接上「退回大地圖並讓時間流逝」
## (見 Scenes/MapLocation/map_location.gd)。
const TYPE_SUB_LOCATIONS: Dictionary = {
	GameEnums.MapObjectType.CASTLE: ["城堡", "酒館", "市集", "聊天", "休息"],
}
