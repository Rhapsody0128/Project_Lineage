...
## 目前所有地圖物件的集中定義(三座城堡+玩家根據地)。texture 暫時給 null,
## 地圖8000*4500
...
## 寫死特定地點類型的選項文字。CASTLE:城堡/酒館/市集是佔位按鈕,聊天已接上
